...
def test(model, test_loader, criterion):
    ...
    logger.info(f"Loss: {loss}, Accuracy: {round((100*accuracy), 2)}%")
...
def main(args):
    ...
    '''
    train_loader, test_loader = create_data_loaders(data=args.data, batch_size=args.batch_size)
    model=train(model, train_loader, loss_criterion, optimizer, args.epoch)
